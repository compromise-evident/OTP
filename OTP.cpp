...
{	cout << "\n(One-time pad)\n\n"
	...
	{	cout << "80 characters max (width of terminal.) Randomness will be appended if your\n"
		...
		if(plaintext[0] == '\0') {cout << "No input visible, program ended. See line 69 if input was given.\n"; return 0;}
	...
	{	cout << "Decrypt in the order received.\n"
		...
		if(ciphertext[0] == '\0') {cout << "No input visible, program ended. See line 314 if input was given.\n"; return 0;}

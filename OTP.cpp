...
/* Version 4.1, plausibility ratio = 1:95, plausible messages per ciphertext =
 ...
 * keys incoming outgoing  (3 folders, all inside keys folder for organization.)
...
--------------------------------------------------------------------------------
IF OPTION 3 (keys in 20 seconds) -  Fast, 203 files, SLIGHTLY WEAKER RANDOMNESS.
 * 0000 - 0099    (3.2MB)   (100 keys in incoming folder, 32,000 char, 200 msg.)
 * 0000 - 0099    (3.2MB)   (100 keys in outgoing folder, 32,000 char, 200 msg.)
--------------------------------------------------------------------------------
IF OPTION 4 (keys in 20m) - 1GB RAM to get keys. 5,123 files, STRONG RANDOMNESS.
  * 0000 - 2559   (256MB)   (2,560 keys in incoming folder, 100k char, 625 msg.)
  * 0000 - 2559   (256MB)   (2,560 keys in outgoing folder, 100k char, 625 msg.)
--------------------------------------------------------------------------------
...
{	cout << "\n(One-time pad)\n\n"
	...
	{	ifstream in_stream;
		...
		out_stream.open(file_name_key_outgoing);
		for(int a = 0; a < 100000; a++) {out_stream.put(-1);} //Binary: 11111111 (same as 255 - extended ASCII.)
		out_stream.close();

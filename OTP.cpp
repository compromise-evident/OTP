...
/// Version 2.1.1, plausibility ratio = 1:95, number of plausible messages per ciphertext = 165,153,743,850,136,394,768,170,261,844,001,846,794,583,739,849,096,139,995,229,484,616,386,098,260,836,764,841,563,284,148,593,084,838,704,354,991,162,901,768,186,888,062,928,119,325,079,023,838,043,212,890,625
...
to get 80 characters. Ciphertext is always 80 characters. Key files contain digit pairs 00 - 94 (95 distinctions.)
...
{	cout << "\n(One-time pad)\n\n"
	...
	{	ifstream in_stream;
		...
		//USELNX If you entered a message and got the "No input visible" error, remove the following two lines of code.
		...
		for(int a = 0;; a++) //Converts plaintext to decimal. Pressing arrow keys in the terminal WILL TRIGGER THE FOLLOWING ELSE!
		{	if(plaintext[a] == '\0') {plaintext_null_bookmark = a; break;}
			
			     if(plaintext[a] == ' ') {plaintext_decimal[a] =  0;}
			else if(plaintext[a] == '!') {plaintext_decimal[a] =  1;}	else if(plaintext[a] == 'P') {plaintext_decimal[a] = 48;}
			else if(plaintext[a] == '"') {plaintext_decimal[a] =  2;}	else if(plaintext[a] == 'Q') {plaintext_decimal[a] = 49;}
			else if(plaintext[a] == '#') {plaintext_decimal[a] =  3;}	else if(plaintext[a] == 'R') {plaintext_decimal[a] = 50;}
			else if(plaintext[a] == '$') {plaintext_decimal[a] =  4;}	else if(plaintext[a] == 'S') {plaintext_decimal[a] = 51;}
			else if(plaintext[a] == '%') {plaintext_decimal[a] =  5;}	else if(plaintext[a] == 'T') {plaintext_decimal[a] = 52;}
			else if(plaintext[a] == '&') {plaintext_decimal[a] =  6;}	else if(plaintext[a] == 'U') {plaintext_decimal[a] = 53;}
			else if(plaintext[a] =='\'') {plaintext_decimal[a] =  7;}	else if(plaintext[a] == 'V') {plaintext_decimal[a] = 54;}
			else if(plaintext[a] == '(') {plaintext_decimal[a] =  8;}	else if(plaintext[a] == 'W') {plaintext_decimal[a] = 55;}
			else if(plaintext[a] == ')') {plaintext_decimal[a] =  9;}	else if(plaintext[a] == 'X') {plaintext_decimal[a] = 56;}
			else if(plaintext[a] == '*') {plaintext_decimal[a] = 10;}	else if(plaintext[a] == 'Y') {plaintext_decimal[a] = 57;}
			else if(plaintext[a] == '+') {plaintext_decimal[a] = 11;}	else if(plaintext[a] == 'Z') {plaintext_decimal[a] = 58;}
			else if(plaintext[a] == ',') {plaintext_decimal[a] = 12;}	else if(plaintext[a] == '[') {plaintext_decimal[a] = 59;}
			else if(plaintext[a] == '-') {plaintext_decimal[a] = 13;}	else if(plaintext[a] =='\\') {plaintext_decimal[a] = 60;}
			else if(plaintext[a] == '.') {plaintext_decimal[a] = 14;}	else if(plaintext[a] == ']') {plaintext_decimal[a] = 61;}
			else if(plaintext[a] == '/') {plaintext_decimal[a] = 15;}	else if(plaintext[a] == '^') {plaintext_decimal[a] = 62;}
			else if(plaintext[a] == '0') {plaintext_decimal[a] = 16;}	else if(plaintext[a] == '_') {plaintext_decimal[a] = 63;}
			else if(plaintext[a] == '1') {plaintext_decimal[a] = 17;}	else if(plaintext[a] == '`') {plaintext_decimal[a] = 64;}
			else if(plaintext[a] == '2') {plaintext_decimal[a] = 18;}	else if(plaintext[a] == 'a') {plaintext_decimal[a] = 65;}
			else if(plaintext[a] == '3') {plaintext_decimal[a] = 19;}	else if(plaintext[a] == 'b') {plaintext_decimal[a] = 66;}
			else if(plaintext[a] == '4') {plaintext_decimal[a] = 20;}	else if(plaintext[a] == 'c') {plaintext_decimal[a] = 67;}
			else if(plaintext[a] == '5') {plaintext_decimal[a] = 21;}	else if(plaintext[a] == 'd') {plaintext_decimal[a] = 68;}
			else if(plaintext[a] == '6') {plaintext_decimal[a] = 22;}	else if(plaintext[a] == 'e') {plaintext_decimal[a] = 69;}
			else if(plaintext[a] == '7') {plaintext_decimal[a] = 23;}	else if(plaintext[a] == 'f') {plaintext_decimal[a] = 70;}
			else if(plaintext[a] == '8') {plaintext_decimal[a] = 24;}	else if(plaintext[a] == 'g') {plaintext_decimal[a] = 71;}
			else if(plaintext[a] == '9') {plaintext_decimal[a] = 25;}	else if(plaintext[a] == 'h') {plaintext_decimal[a] = 72;}
			else if(plaintext[a] == ':') {plaintext_decimal[a] = 25;}	else if(plaintext[a] == 'i') {plaintext_decimal[a] = 73;}
			else if(plaintext[a] == ';') {plaintext_decimal[a] = 27;}	else if(plaintext[a] == 'j') {plaintext_decimal[a] = 74;}
			else if(plaintext[a] == '<') {plaintext_decimal[a] = 28;}	else if(plaintext[a] == 'k') {plaintext_decimal[a] = 75;}
			else if(plaintext[a] == '=') {plaintext_decimal[a] = 29;}	else if(plaintext[a] == 'l') {plaintext_decimal[a] = 76;}
			else if(plaintext[a] == '>') {plaintext_decimal[a] = 30;}	else if(plaintext[a] == 'm') {plaintext_decimal[a] = 77;}
			else if(plaintext[a] == '?') {plaintext_decimal[a] = 31;}	else if(plaintext[a] == 'n') {plaintext_decimal[a] = 78;}
			else if(plaintext[a] == '@') {plaintext_decimal[a] = 32;}	else if(plaintext[a] == 'o') {plaintext_decimal[a] = 79;}
			else if(plaintext[a] == 'A') {plaintext_decimal[a] = 33;}	else if(plaintext[a] == 'p') {plaintext_decimal[a] = 80;}
			else if(plaintext[a] == 'B') {plaintext_decimal[a] = 34;}	else if(plaintext[a] == 'q') {plaintext_decimal[a] = 81;}
			else if(plaintext[a] == 'C') {plaintext_decimal[a] = 35;}	else if(plaintext[a] == 'r') {plaintext_decimal[a] = 82;}
			else if(plaintext[a] == 'D') {plaintext_decimal[a] = 36;}	else if(plaintext[a] == 's') {plaintext_decimal[a] = 83;}
			else if(plaintext[a] == 'E') {plaintext_decimal[a] = 37;}	else if(plaintext[a] == 't') {plaintext_decimal[a] = 84;}
			else if(plaintext[a] == 'F') {plaintext_decimal[a] = 38;}	else if(plaintext[a] == 'u') {plaintext_decimal[a] = 85;}
			else if(plaintext[a] == 'G') {plaintext_decimal[a] = 39;}	else if(plaintext[a] == 'v') {plaintext_decimal[a] = 86;}
			else if(plaintext[a] == 'H') {plaintext_decimal[a] = 40;}	else if(plaintext[a] == 'w') {plaintext_decimal[a] = 87;}
			else if(plaintext[a] == 'I') {plaintext_decimal[a] = 41;}	else if(plaintext[a] == 'x') {plaintext_decimal[a] = 88;}
			else if(plaintext[a] == 'J') {plaintext_decimal[a] = 42;}	else if(plaintext[a] == 'y') {plaintext_decimal[a] = 89;}
			else if(plaintext[a] == 'K') {plaintext_decimal[a] = 43;}	else if(plaintext[a] == 'z') {plaintext_decimal[a] = 90;}
			else if(plaintext[a] == 'L') {plaintext_decimal[a] = 44;}	else if(plaintext[a] == '{') {plaintext_decimal[a] = 91;}
			else if(plaintext[a] == 'M') {plaintext_decimal[a] = 45;}	else if(plaintext[a] == '|') {plaintext_decimal[a] = 92;}
			else if(plaintext[a] == 'N') {plaintext_decimal[a] = 46;}	else if(plaintext[a] == '}') {plaintext_decimal[a] = 93;}
			else if(plaintext[a] == 'O') {plaintext_decimal[a] = 47;}	else if(plaintext[a] == '~') {plaintext_decimal[a] = 94;}
			...
			{	cout << "\nDefective input, try again.\n";
				...
				for(int a = 0; a < 80; a++)
				{	for(int b = 0; b < 10; b++) {plaintext[a] = b;}
					for(int c = 0; c < 10; c++) {plaintext_decimal[a] = c;}
		...
		for(int a = 0; a < 200000000; a++)
		{	for(int b = 0; b < 10; b++) {key_outgoing[a] = b;}
		}
		
		//Overwrites RAM of array plaintext_decimal[].
		for(int a = 0; a < 80; a++)
		{	for(int b = 0; b < 10; b++) {plaintext_decimal[a] = b;}
		...
		for(int a = 0; a < 80; a++)
		{	for(int b = 0; b < 10; b++) {sub_key[a] = b;}
		} //Only partially effective, printed/copied text is cloned from RAM.
	...
	{	ifstream in_stream;
		...
		//WINBAD If you entered a message and got the "No input visible" error, remove the following two lines of code.
		char nothing_to_see_here[1]; //This is here to catch the cached new line.
		cin.getline(nothing_to_see_here, 1);
		...
		for(int a = 0; a < 200000000; a++)
		{	for(int b = 0; b < 10; b++) {key_incoming[a] = b;}
		}
	...
	{	ifstream in_stream;
		...
		//If you are testing or playing with the code, set the following testing variable
		//to "true" (forces one user-input for seeds, faster gen & no RAM overwriting.)
		bool testing = false;
		int ninety = 90;
		int two_hundred_million = 200000000;
		if(testing == true)
		{	ninety = 1;
			two_hundred_million = 0;
		}
		
		//Checks if files already exist.
		in_stream.open("key.outgoing");
		char sniffed_one_file_character[1];
		in_stream >> sniffed_one_file_character[0];
		out_stream.close();
		if((sniffed_one_file_character[0] >= 48) && (sniffed_one_file_character[0] <= 57))
		{	cout << "\n\nKeys already exist, run OTP.cpp a different folder.\n"
			     << "Overwrite files anyway? y/n: ";
			char wait;
			cin >> wait;
			if(wait != 'y') {return 0;}
		}
		...
		//Fills array user_seed[] with 90 user-defined seeds of size 9.
		unsigned int user_seed[90];
		for(int a = 0; a < ninety; a++)
		...
		for(int a = 0; a < ninety; a++) //Constructively applies random digits to table_private[] based on the 90 seeds provided by the user.
		...
		for(int a = 0; a < two_hundred_million; a++)
